...
- **Autorizador:** Profissional responsável por analisar os laudos médicos para a emissão da **AIH** e decidir se a internação ou o procedimento será autorizado. Essa função pode ser desempenhada por:
...
### Quando a nova AIH é necessária?
...
1. **Identificação da necessidade de mudança:**  
   - O médico responsável identifica que o tratamento ou procedimento inicial deve ser alterado.  
...
2. **Emissão de novo laudo e justificativa:**  
   - O médico emite um laudo atualizado justificando a alteração do procedimento.  
...
3. **Solicitação de autorização pela Central de Regulação:**  
   - O hospital solicita uma nova autorização à Central de Regulação do SUS.  
...
4. **Atualização da AIH:**  
   - Se a mudança for aprovada, a AIH é atualizada com o novo procedimento.  
...
5. **Documentação e Faturamento:**  
   - A mudança de procedimento deve ser registrada no prontuário do paciente.  
...
- **Complicações pós-cirúrgicas:**  
  - Exemplo: Um paciente que passa por cirurgia e desenvolve uma infecção pode precisar de drenagem ou antibioticoterapia, que não estavam incluídos inicialmente.

- **Agravamento do quadro clínico:**  
  - Exemplo: Um paciente com diagnóstico inicial de pneumonia que evolui para insuficiência respiratória e requer internação em UTI.

- **Necessidade de procedimentos adicionais:**  
  - Exemplo: Inserção de dispositivos como cateteres ou drenos, ou uma nova cirurgia devido a complicações.
...
- **AIH 1 - Inicial:**  
  - Autoriza a primeira internação de um paciente.  
  - Emitida no momento da admissão.  
  - Cobre o período estimado para o diagnóstico e tratamento.

- **AIH 5 - Continuidade:**  
  - Utilizada quando o tratamento precisa ser prolongado além da AIH inicial.  
...
- **Diagnóstico Principal:**  
  - Condição médica que justifica a internação do paciente.  
  - Pode diferir do diagnóstico inicial após exames e novas informações.  

- **Diagnóstico Secundário:**  
  - Condições coexistentes no momento da admissão ou adquiridas durante a internação.  
  - Podem influenciar o curso do tratamento e tempo de internação.  
